...
func (j *jsiiProxy_DataHcsCluster) Count() interface{} {
...
func (j *jsiiProxy_DataHcsCluster)SetCount(val interface{}) {
...
func DataHcsCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataHcsCluster_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataHcsCluster) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataHcsCluster) ToHclTerraform() interface{} {
	var returns interface{}
