...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataHcsCluster)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcs.dataHcsCluster.DataHcsClusterConfig",
		reflect.TypeOf((*DataHcsClusterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcs.dataHcsCluster.DataHcsClusterTimeouts",
		reflect.TypeOf((*DataHcsClusterTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-hcs.dataHcsCluster.DataHcsClusterTimeoutsOutputReference",
		reflect.TypeOf((*DataHcsClusterTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
