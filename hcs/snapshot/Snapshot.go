...
import (
	...
	"github.com/cdktf/cdktf-provider-hcs-go/hcs/v7/snapshot/internal"
...
func (j *jsiiProxy_Snapshot) FinishedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"finishedAt",
...
func (j *jsiiProxy_Snapshot) ManagedApplicationName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Snapshot) ManagedApplicationNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Snapshot) RequestedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"requestedAt",
...
func (j *jsiiProxy_Snapshot) RestoredAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"restoredAt",
...
func (j *jsiiProxy_Snapshot) SnapshotName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"snapshotName",
...
func (j *jsiiProxy_Snapshot) SnapshotNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"snapshotNameInput",
...
func (j *jsiiProxy_Snapshot) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func NewSnapshot(scope constructs.Construct, id *string, config *SnapshotConfig) Snapshot {
	...
	_jsii_.Create(
		"@cdktf/provider-hcs.snapshot.Snapshot",
...
func (j *jsiiProxy_Snapshot)SetManagedApplicationName(val *string) {
...
func (j *jsiiProxy_Snapshot)SetSnapshotName(val *string) {
